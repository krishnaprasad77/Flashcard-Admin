...
import { History, WarningAmberRounded } from '@mui/icons-material';
import { IconButton } from '@mui/material';
const ServerErrorPage = () => {

    let location = useLocation();
    let navigate = useNavigate();
    let value = "Something went wrong" || location.state.value;
            ...
            <Grid container minHeight="85vh">
                <Grid container display={"flex"} justifyContent="center" alignItems={"center"} >
                    <Grid item display={"flex"} gap={2} lg={12} alignItems="center" flexDirection={"column"}>
                        <IconButton sx={{ textAlign: 'center' }}>  <WarningAmberRounded sx={{ fontSize: "50px", fill: "#FFBC3A" }} /></IconButton>
